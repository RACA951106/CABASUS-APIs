...
namespace CabasusAPIs.Controllers
{
    ...
    public class UsuarioController : Controller
    {
        ...
        public bool actualizar([FromBody] JObject data)
        {
            ...
            return c.Insertar("update usuarios set nombre='" + datos.nombre + "',contrasena='" + HashSHA1(datos.contrasena) + "', fecha_nacimiento= '" + datos.fecha_nacimiento + "', descripcion='"+datos.descripcion+"',telefono='"+datos.telefono+"' where id_usuario='" + id_usuario + "'");
        }
        [HttpGet("consultar")]
